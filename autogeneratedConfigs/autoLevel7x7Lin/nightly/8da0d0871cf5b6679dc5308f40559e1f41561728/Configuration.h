 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -6, 0 } //ORIGINAL: #define NOZZLE_TO_PROBE_OFFSET { 10, 10, 0 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
...
#define X_MIN_POS 0
#define Y_MIN_POS 0
#define Z_MIN_POS -5 //ORIGINAL: #define Z_MIN_POS 0
